  ...
  <div>
    <form class="flex gap-1" @submit.prevent="submitCoupon">
      <input
        ...
        class="w-full px-4 py-2 bg-white border border-stone-300 rounded-md shadow-sm outline-none"
        required />
      <button class="flex items-center justify-center px-4 py-2 text-white bg-stone-800 border rounded-md shadow-sm outline-none min-w-20" :disabled="isUpdatingCoupon">
