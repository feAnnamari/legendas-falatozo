...
<template>
  <Transition name="fade" mode="out-in">
    <button type="button" v-if="!isOpen" class="flex items-center gap-2 mt-4 text-sm text-stone-400 cursor-pointer" @click="showShare">
    ...
    <div v-else class="flex items-center gap-2 mt-4 text-sm text-stone-400 cursor-pointer">
      <!-- Twitter -->
