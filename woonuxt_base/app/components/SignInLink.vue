    ...
    <Transition name="pop-in" mode="out-in">
      <span v-if="avatar" class="relative avatar">
        ...
        <div class="account-dropdown">
          <NuxtLink :to="wishlistLink" class="hover:bg-stone-100"><Icon name="ion:heart-outline" size="16" /><span>Wishlist</span></NuxtLink>
          <NuxtLink to="/my-account" class="hover:bg-stone-100"><Icon name="ion:person-outline" size="16" /><span>My Account</span></NuxtLink>
...
.avatar {
  .account-dropdown {
    @apply absolute gap-2 top-6 -right-2  z-50 p-2 bg-white border border-stone-200 rounded-lg shadow-lg text-sm text-stone-700 hidden;
